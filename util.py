...
#     title='测试'
#     message = "大家好!我是机器人.\n\n世博会新NFT:\n\n {} 出现了!\n\n 快去领取吧!\n\n {}".format(title,
#                                                                             "https://expo.chikoroko.art/referral/x28kalbqlq") + \
...
#     send_pushplus('测试标题', '#:/这只是个测试，202111141003/' + message, 'announcements')
#
...
#
# print("微信推送失败2")
# title='一二三四 '+ ':' +'五六七八九十一二三四五六七八九十一二三四五六七八九十一二三四五六七八九十一二三四五六七八九十一二三四五六七八九十一二三四五六七八九十一二三四五六七八九十一二三四五六七八九十一二三四五六七八九十'
# send_pushplus_wx(title[0:50], '#:/这只是个#测?试&，202111141003/', 'wxpp')